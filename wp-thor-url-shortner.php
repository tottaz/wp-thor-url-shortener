...
Plugin URI:
Description: This is a url shortner that works with moln.co.
Version: 1.0.0
...
//
define('THORURLSHORTENER_VERSION', '1.0.0');
...
define('THORURLSHORTENER_PLUGIN_LICENSE_PAGE', 'thor_custom_plugin_template_admin&tab=licenses' );

if( !class_exists( 'EDD_SL_Plugin_Updater' ) ) {
	// load our custom updater
	require_once THORURLSHORTENER_PLUGIN_PATH . '/app/edd-include/EDD_SL_Plugin_Updater.php';
}
